...
// Enum tanımları için bkz. _Game/Data/CardEnums.cs
...
public class CardData : ScriptableObject
{
    ...
    public float cardToplamaSuresi; // Kartın kaç turda bir enerji kazandıracağı. İlk eklendiğinde çalışmaz. O değerdeki tur kadar sonra ilk defa kazandırır.
